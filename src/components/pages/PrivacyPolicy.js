  ...
  return (
    <div className="Humus-header">
      <div className="Header">
        ...
        <p className="para">Last updated: 17 August 2021</p>
        <p className="para">
        ...
        <p className="para">Definitions</p>
        ...
        <p className="para">
          ...
          this Agreement) refers to VC Agritech Pvt Ltd, #13/65, 5th Main, 15th
          Cross, Lakkasandra.
        </p>
        <p className="para">
        ...
        <p className="para">Country refers to: Karnataka, India</p>
        <p className="para">
        ...
        <p className="para">Service refers to the Website.</p>
        <p className="para">
        ...
        <p className="para">
          Website refers to VC Agritech Pvt Ltd, accessible from humus.co.in
        </p>
        <p className="para">
        ...
        <p className="para">First name and last name</p>
        <p className="para">Phone number</p>
        <p className="para">Address, State, Province, ZIP/Postal code, City</p>
        ...
        <p className="para">Tracking Technologies and Cookies</p>
        <p className="para">
        ...
        <p className="para">Necessary / Essential Cookies</p>
        ...
        <p className="para">Cookies Policy / Notice Acceptance Cookies</p>
        ...
        <p className="para">Functionality Cookies</p>
        <p className="para">Type: Persistent Cookies</p>
        <p className="para">Administered by: Us</p>
        <p className="para">
        ...
        <p className="para">Use of Your Personal Data</p>
        <p className="para">
        ...
        <p className="para">
          ...
          profile. With Your consent: We may disclose Your personal information
          for any other purpose with Your consent.
        </p>
        <p className="para">Retention of Your Personal Data</p>
        <p className="para">
          ...
          <p className="para">Transfer of Your Personal Data</p>
          <p className="para">
          ...
          <p className="para">Law enforcement</p>
          <p className="para">
          ...
          <p className="para">Other legal requirements</p>
          <p className="para">
          ...
          <p className="para">Protect against legal liability</p>
          <p className="para">Security of Your Personal Data</p>
          <p className="para">
          ...
          <p className="para">Children's Privacy</p>
          <p className="para">
          ...
          <p className="para">Links to Other Websites</p>
          <p className="para">
          ...
          <p className="para">Changes to this Privacy Policy</p>
          <p className="para">
          ...
          <p className="para">By email: vp@humus.co.in</p>
        </p>
      </div>
    </div>
  );
